...
void *process_manager(void *arg) {
    ...
    /*Semáforos para la sincronización y gestionar los prints*/
    ...
    /* Inicializar mutex, condvars y belt */
    ...
    /* Join hilos productor y consumidor */
    ...
    /* Notificar al factory_manager que ha terminado */
    sem_post(&p->done_sem[p->index]);
